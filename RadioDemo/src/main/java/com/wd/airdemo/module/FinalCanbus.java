...
public class FinalCanbus {
    ...
    public static final int U_RefrigerationOrHeatingMode= U_Start + 1;//冷/制热模式
    ...
    public static final int U_ReportStatus              = U_Start + 12;
    ...
    public static final int U_MAX                       = U_SystemModeReq + 1;
    ...
    public static final int C_BCM_Horn                  = C_Start + 12; // 喇叭状态
    ...
    public static final int C_TS_PressState             = C_Start + 22; // 触摸按压状态
